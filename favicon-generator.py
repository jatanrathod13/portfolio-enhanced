...
<script>
      window.onload = function() {
        setTimeout(function() {
          ...
          var promos = document.querySelectorAll(".a8kfu9");
...
<div class="a8kfu92" style="background-color:#FCFCFC;width: 728px;height:90px;padding:10px;border:1px solid #cccccc;text-align:left;">\
...
Generate a suggested list of keywords for your SEO and Ad campaigns for free!\
		    ...
		    var promotwo = document.querySelector(".a8kfu92");
...
<h3 class="text-center hidden-xs hidden-sm hidden">Favicon & App Icon Generator</h3>
<br/>
...
<!--<div class="col-md-4 hidden-xs hidden-sm hidden-md a8kfu9" style="vertical-align:top;display:inline-block; height:100px;">

</div>-->
        <div id="favcontent">
            <p>Unfortunately the page you requested could not be found. <a href="/">Return to the tool.</a></p>
        </div>
<br />
<br />
<center>
